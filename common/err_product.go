...
const PRODUCT_CREATE = "There was a error when create product"
const PRODUCT_UPDATE = "There was a error when update product"
const PRODUCT_CANT_NEGATIVE = "product id cannot be negative"
